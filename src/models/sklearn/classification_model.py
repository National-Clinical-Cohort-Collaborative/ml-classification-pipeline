...
class ClassificationModel:
    def __init__(self, model_name, classification_model, param_grid, dataset, n_iterations, train_test_ratio, preprocess_exclude_columns, standardize_exclude_columns):
        self.model_name = "Logistic Regression"
        self.dataset = dataset
        self.classification_model = classification_model
        self.param_grid
        self.n_iterations = n_iterations
        self.dataset_preprocessor = dataset_preprocessor.DatasetPreprocessor(
    ...
    def run_iteration(self, X_train, y_train, X_test, y_test, itr):
        ...
        for evaluation_param in evaluation_params:
            ...
            cv_model = GridSearchCV(estimator=self.classification_model, param_grid=self.param_grid,
